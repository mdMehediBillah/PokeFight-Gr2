...
const Gamepage = () => {
  ...
  const handlePlay = () => {
    ...
    // const result = playerChoice === randomChoice? "It's a tie!" : playerChoice > randomChoice? "Player wins!" : "Computer wins!";
    // setWinner(result);
    // setOpenModal(true);
    // navigate("/result", { state: { selectedPokemon, randomPokemon } });
  };
  const handlePlay2 = () => {
      ...
      >
        ...
        <div className="fight-container flex flex-row items-center pb-8 h-full">
          ...
          <div className="pokecard border rounded-lg p-4 mx-4 mb-8 text-center w-72 h-90">
            ...
            <p className="pokecard-description">
