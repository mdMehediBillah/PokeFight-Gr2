...
const LoseModal = ({ closeModal, selectedPokemon }) => {
      ...
      >
        ...
        <div>
          <p className="text-center mt-2 text-black text-xl">
            Your Pokemon <strong>{selectedPokemon.name}</strong> lose
          </p>
        </div>
        <div className="flex mt-6 justify-between gap-4 mt-16">
          <button className=" bg-orange-300 hover:bg-orange-200 text-black font-semibold py-2 rounded w-full">
            Play again
          </button>
